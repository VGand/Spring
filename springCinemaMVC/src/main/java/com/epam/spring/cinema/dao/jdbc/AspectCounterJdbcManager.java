...
public class AspectCounterJdbcManager implements AspectCounterManager {
    ...
    private final String GET_COUNTER_BY_NAME = "SELECT ASPECT_COUNTER FROM ASPECTS_COUNTERS WHERE ASPECT_NAME = ?";
    private final String INSERT_COUNTER = "INSERT INTO ASPECTS_COUNTERS (ASPECT_NAME, ASPECT_COUNTER) VALUES(?, ?)";
    private final String UPDATE_COUNTER = "UPDATE ASPECTS_COUNTERS SET ASPECT_COUNTER = ASPECT_COUNTER + 1 WHERE ASPECT_NAME = ?";
