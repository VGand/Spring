        ...
        while (command != 0) {
            ...
            switch (command) {
                case 1: {
                    ...
                    LocalDateTime inputDateTime = CinemaDateUtils.getDateTimeByFormat(scanner.next(), CinemaConstants.DATE_FORMAT);
                ...
                case 2: {
                    System.out.print("Введите начальную дату и время в формате (дд.мм.гггг-чч:мм): ");
                    LocalDateTime fromDateTime = CinemaDateUtils.getDateTimeByFormat(scanner.next(), CinemaConstants.DATE_FORMAT);

                    System.out.print("Введите конечную дату и время в формате (дд.мм.гггг-чч:мм): ");
                    LocalDateTime toDateTime = CinemaDateUtils.getDateTimeByFormat(scanner.next(), CinemaConstants.DATE_FORMAT);
                ...
                case 4: {
                    ...
                    while (subCommand != 0) {
                        ...
                        if (ticket == null) {
                            System.out.println("Такой билет уже продан!");
                        } else {
